		...
		if len(each_file) > 0:
			...
			for file in each_file:
				...
				try:
					...
					#do a regex for each item in `gather` list
					...
					try:
						...
						try:
							...
							# get the data from the quandl file(YAHOO-INDEX_GSPC.csv) on a weekend
